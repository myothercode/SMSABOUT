...
/*******************************************************************************
 * MD5Code 类实现了RSA Data Security, Inc.在提交给IETF 的RFC1321中的keyBean message-digest
 * 算法。
 ******************************************************************************/
public class MD5Code {
	private static MD5Code instance=null;
	
	static public synchronized MD5Code getInstance() {
	...
	/*
	 * 下面的三个成员是MD5Code计算过程中用到的3个核心数据，在原始的C实现中 被定义到keyBean_CTX结构中
	 */
